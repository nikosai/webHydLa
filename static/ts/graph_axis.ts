declare var dat_gui_parameter_folder: any;
declare var plot_settings: any;
declare var dat_gui_parameter_folder_seek: any;
declare var time: any;
declare var animate: any;
declare var replot_all: any;
declare var plot_lines: any;
declare var dat_gui_variable_folder: any;
declare var remove_plot: any;
declare var settingsForCurrentHydat: any;
declare var browser_storage: any;
declare var current_hydat: any;
declare var replot: any;
declare var range_mode: any;

var dat_gui_parameter_items: any = [];
function parameter_setting(pars: any) {
  ...
  for (var key in pars) {
    (function (key_copy) {
      ...
      parameter_item.onChange(function (value: any) { replot_all() });
      ...
      mode_item.onChange(function (value: any) {
      ...
      mode_item_range.onChange(function (value: any) {
...
var dat_gui_parameter_items_seek: any = [];
function parameter_seek_setting(line_len: number) {
  ...
  parameter_item_seek.onChange(function (value: any) {/*replot_all();*/time = plot_settings.parameter_condition_seek.value; animate(); });
...
function parameter_seek_setting_animate(line_len: number, time_line: number) {
  for (var i = 0; i < dat_gui_parameter_items_seek.length; i++) {
    dat_gui_parameter_folder_seek.remove(dat_gui_parameter_items_seek[i]);
  }
  dat_gui_parameter_items_seek = [];
...
function updateFolder(line: any, succeeded: any) {
  if (succeeded) {
...
function createUpdateFunctionForLine(line: any, item: any) {
...
function addNewLine(x_name: string | undefined, y_name: string | undefined, z_name: string | undefined) {
...
function addNewLineWithIndex(x_name: string | undefined, y_name: string | undefined, z_name: string | undefined, index: number) {
...
function addNewLineWithIndexGuard(x_name: string | undefined, y_name: string | undefined, z_name: string | undefined, index: number) {
